...
[dynamicUnstable, unstableReason, unstableFlags] = classifyDynamicStabilityLocal( ...
...
resultTable = table( ...
    ...
    dynamicUnstable, unstableFlags.by_frequency, unstableFlags.by_rotor_angle, ...
    unstableFlags.by_unresolved_relay, unstableFlags.by_sim_failure, unstableFlags.by_other, ...
    string(unstableReason), passiveRelayTripCount, securityRedispatchCount, ...
    ...
    "dynamic_trip_count", "dynamic_unstable", "dynamic_unstable_by_frequency", ...
    "dynamic_unstable_by_rotor_angle", "dynamic_unstable_by_unresolved_relay", ...
    "dynamic_unstable_by_sim_failure", "dynamic_unstable_by_other", ...
    "unstable_reason", "passive_relay_trip_count", ...
...
function [dynamicUnstable, unstableReason, flags] = classifyDynamicStabilityLocal(frequencyNadirHz, maxRotorAngleSeparationDeg, maxLineLoadingRatio, maxRelayViolationLoadingRatio, passiveRelayTripCount, options)
reasons = strings(0, 1);
flags = struct("by_frequency", false, "by_rotor_angle", false, "by_unresolved_relay", false, "by_sim_failure", false, "by_other", false);
if frequencyNadirHz < options.frequency_unstable_threshold_hz
    reasons(end + 1, 1) = "frequency_nadir_below_49hz";
    flags.by_frequency = true;
end
...
if maxRelayViolationLoadingRatio > options.relay_beta && passiveRelayTripCount == 0
    ...
    flags.by_unresolved_relay = true;
end
