function resultTable = run_rts79_dynamic_batch(basecasePath, matlabBatchInputCsv, outputDir, saveTrajectories, options)
...
for idx = 1:numel(caseIds)
    parts{idx} = run_rts79_dynamic_path_case(basecasePath, matlabBatchInputCsv, caseIds(idx), outputDir, saveTrajectories, options);
end
