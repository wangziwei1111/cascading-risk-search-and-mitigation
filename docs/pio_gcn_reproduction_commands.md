...
Figures are generated by the formal experiment, ablation, pairwise rank-loss, synthetic renewable, and Top-K depth tradeoff scripts. Main output directories:
