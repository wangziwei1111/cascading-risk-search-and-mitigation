...
OUT_DIR = ROOT / "results/gcn_search/ieee39_spp001_same_wrapper_bridge_smoke_rerun"
DOC = ROOT / "docs/ieee39_spp001_same_wrapper_bridge_smoke_rerun.md"
...
def test_spp001_bridge_smoke_rerun_writes_artifacts() -> None:
    subprocess.run(
        [
            sys.executable,
...
def test_spp001_bridge_smoke_rerun_artifacts_exist() -> None:
    expected = [
        "spp001_bridge_smoke_rerun_approval.json",
        "spp001_bridge_smoke_rerun_approval.md",
        "spp001_bridge_smoke_rerun_summary.json",
        "spp001_bridge_smoke_rerun_summary.md",
        "spp001_bridge_smoke_rerun_summary.csv",
        "spp001_bridge_smoke_rerun_result.json",
        "spp001_bridge_smoke_rerun_result.md",
        "spp001_bridge_smoke_rerun_result.csv",
        "spp001_bridge_smoke_label_distribution.json",
        "spp001_bridge_smoke_label_distribution.md",
        "no_leakage_spp001_bridge_smoke_audit.json",
        "no_leakage_spp001_bridge_smoke_audit.md",
        "large_file_safety_spp001_bridge_smoke.json",
        "large_file_safety_spp001_bridge_smoke.md",
    ]
...
def test_spp001_bridge_smoke_rerun_summary_contract() -> None:
    approval = _read_json(OUT_DIR / "spp001_bridge_smoke_rerun_approval.json")
    summary = _read_json(OUT_DIR / "spp001_bridge_smoke_rerun_summary.json")
    result = _read_json(OUT_DIR / "spp001_bridge_smoke_rerun_result.json")
    distribution = _read_json(OUT_DIR / "spp001_bridge_smoke_label_distribution.json")

    assert approval["approval_scope"] == "spp001_same_wrapper_bridge_smoke_rerun_approval"
    assert approval["approved_selected_pairs_only"] is True
    assert approval["single_pair_smoke_only"] is True
...
def test_spp001_bridge_smoke_rerun_no_leakage_and_safety() -> None:
    no_leakage = _read_json(OUT_DIR / "no_leakage_spp001_bridge_smoke_audit.json")
    safety = _read_json(OUT_DIR / "large_file_safety_spp001_bridge_smoke.json")
...
def test_spp001_bridge_smoke_rerun_docs_are_conservative() -> None:
    text = "\n".join(
        [
            _read_text(DOC),
            _read_text(ROOT / "docs/gcn_pio_validation_log.md"),
            _read_text(OUT_DIR / "spp001_bridge_smoke_rerun_summary.md"),
            _read_text(OUT_DIR / "spp001_bridge_smoke_rerun_result.md"),
        ]
    ).lower()
...
def test_spp001_bridge_smoke_rerun_no_forbidden_large_artifacts_tracked() -> None:
