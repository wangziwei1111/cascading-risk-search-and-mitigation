# IEEE39 Selected Pair Execution Summary
...
- `recommended_next_step`: fix controlled execution environment or run selected pair execution locally, then rerun evidence collection
- `source_dry_run_pair_count`: 32
- `approved_selected_pairs_only`: True
- `feature_matrix_rows_available`: 34
- `prior_no_leakage_policy_passed`: True
