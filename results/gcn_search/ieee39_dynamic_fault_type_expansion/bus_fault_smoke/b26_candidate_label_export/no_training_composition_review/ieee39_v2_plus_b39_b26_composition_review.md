...
B39 and B26 are now both in the candidate-label table as temporary bus-fault
samples. This review checks whether the table is internally consistent before
any later model experiment. It is a paperwork and data-consistency gate, not a
training result.
...
## Duplicate And Provenance Check
...
run v2-plus-B39+B26 preview/no-leakage comparison in a separate round, still not GCN usefulness audit.
