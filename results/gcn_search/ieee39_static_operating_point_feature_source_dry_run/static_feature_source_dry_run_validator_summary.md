...
- `blocker_if_any`: relay threshold is available only as an unapproved beta * RATE_A proxy proposal
- `recommended_next_step`: document and approve relay threshold proxy before paper-style label generator
